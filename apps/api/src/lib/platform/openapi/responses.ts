...
export function withCreatedResponse<T extends z.ZodType>(schema: T, description: string) {
  return {
...
export function withErrorResponses<T extends Record<number, z.ZodType | undefined>>(
  successResponses: T,
) {
  return {
    ...successResponses,
