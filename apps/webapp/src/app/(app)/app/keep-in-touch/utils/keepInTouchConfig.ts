...
export const KEEP_IN_TOUCH_PRESETS = [
  { days: 7, labelKey: "FrequencyWeekly", value: "7" },
  { days: 14, labelKey: "FrequencyBiweekly", value: "14" },
  { days: 90, labelKey: "FrequencyQuarterly", value: "90" },
  { days: 180, labelKey: "FrequencyBiannually", value: "180" },
  { days: 365, labelKey: "FrequencyYearly", value: "365" },
] as const;
...
export function computeNextDueDate(
  ...
  if (!lastInteraction || !keepFrequencyDays) {
    return null;
  }
