...
import { Modal, Text, Group, Stack, Avatar, Button, Textarea, ActionIcon, Box, ThemeIcon, Divider } from "@mantine/core";
import { IconCalendar, IconMail, IconBrandLinkedin, IconBrandGoogle, IconX, IconTrash, IconExternalLink, IconUserPlus } from "@tabler/icons-react";
...
export function ActivityDetailModal({ activity, opened, onClose, contacts }: ActivityDetailModalProps) {
  ...
  const participants = (activity.participants || []).map((p: any) => {
      ...
      <Stack gap="lg">
        ...
        <Box>
            <Group justify="space-between" mb="sm">
                <Text fw={600} size="sm" c="dimmed" tt="uppercase">Attendees</Text>
            ...
            <Stack gap="md">
                {participants.length > 0 ? participants.map(participant => (
                    <Group key={participant.id} justify="space-between">
                        ...
                        <Group gap="xs">
                            ...
                            {participant.linkedin && (
                             ...
                             {/* Email Action */}
                             {(participant.emails as any)?.[0]?.value && <ActionIcon 
                                component="a" 
                    ...
                    <Text c="dimmed" size="sm">No attendees</Text>
                )}
            </Stack>
        </Box>
