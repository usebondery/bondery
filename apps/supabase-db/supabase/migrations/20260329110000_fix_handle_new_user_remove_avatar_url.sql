-- Fix handle_new_user() trigger to stop referencing the dropped avatar_url column.
--
-- Migration 20260328100000 dropped user_settings.avatar_url but did not update
-- the handle_new_user() trigger, causing "Database error saving new user" on signup.
