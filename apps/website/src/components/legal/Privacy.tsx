      ...
      <Grid gutter="xl">
        ...
        <Grid.Col span={{ base: 12, md: 9 }}>
          <Paper p="xl" radius="md" withBorder>
            ...
            <Text mb="lg">
              PixelDev s.r.o., IČ: 23476800 (&quot;PixelDev,&quot; &quot;Bondery,&quot;
              &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) respects the privacy of its users
              (&quot;User,&quot; &quot;your,&quot; or &quot;you&quot;). This Privacy Policy explains
              how we collect, use, disclose, and safeguard your information when you use
              Bondery&apos;s platform, websites, web application, browser extension, and API
              (together &quot;Services&quot;).
            </Text>
            ...
            <Text mb="lg">
              ...
              Services, you agree to accept all the terms contained in this Privacy Policy and
              acknowledge and agree with the practices described herein.
            </Text>
            ...
            <Text mb="md">
              Bondery is a personal relationship manager (PRM) and network management tool that
              helps you organize, track, and nurture your personal and professional relationships.
            ...
            <List mb="lg" withPadding listStyleType="disc">
              ...
              <List.Item>
                <strong>Bondery Browser Extension</strong> – A Chrome extension that helps you
                import contact information from social platforms
              </List.Item>
              <List.Item>
            ...
            <Text mb="lg">
              When you register for Bondery, we collect basic account information necessary to
              create and manage your account, such as your email address, authentication
              credentials, and any third-party login identifiers if you choose to sign in via OAuth
              providers.
            </Text>
            ...
            <Text mb="lg">
              You may optionally provide profile information (such as your name and profile photo)
              and preferences (such as language and display settings) to personalize your
              experience.
            </Text>
            ...
            <Text mb="md">
              The core function of Bondery is to help you manage your personal network. You may
              store various types of information about your contacts, relationships, activities, and
              interactions. This may include names, contact details, social media handles, notes,
              photos, dates, location information, and other data you choose to enter.
            </Text>
            <Text mb="lg" c="dimmed" fz="sm">
              <strong>Important:</strong> You are responsible for ensuring you have the appropriate
              legal basis to store information about other individuals in your Bondery account. We
              act as a data processor for this contact data on your behalf.
            </Text>
            ...
            <Text mb="lg">
              ...
              information from supported websites when you explicitly initiate an import action.
              This data is used to pre-fill contact forms in Bondery. The extension only activates
              when you click the Bondery button and does not automatically collect or transmit data.
            </Text>
            ...
            <Text mb="lg">
              ...
              including IP addresses, browser and device information, access timestamps, and server
            ...
            <Text mb="lg">
              We may use analytics tools to understand how users interact with our Services and to
              improve them. This may include page views, feature usage, session duration, and
              anonymized interaction data. You may be able to opt out of analytics tracking in your
            ...
            <Text mb="lg">
              If you submit feedback, contact us for support, or otherwise communicate with us, we
              collect the content of your communications and your contact information for response
              purposes.
            </Text>
            ...
            <Text mb="lg">
              We do not process biometric data. We do not access your social media accounts directly
              — any browser extension functionality only reads publicly visible page content that
              you explicitly choose to import.
            </Text>
            ...
            <List mb="lg" withPadding listStyleType="disc">
              <List.Item>
                <strong>Provide our Services</strong> – Create and manage your account, store and
                display your contacts and activities, sync data across your devices
              </List.Item>
              <List.Item>
                <strong>Authenticate you</strong> – Verify your identity and manage secure access to
                your account
              </List.Item>
              <List.Item>
              ...
              <List.Item>
                <strong>Communicate with you</strong> – Respond to your inquiries, send
                service-related notifications, and provide support
              </List.Item>
              <List.Item>
            ...
            <Text mb="lg">
              ...
              contractual need, or a legitimate business interest. You may object to processing
              based on legitimate interests at any time by contacting us.
            </Text>
            ...
            <Text mb="lg">
              You are responsible for securing your passwords and devices. That includes following
              best practices like using strong, unique passwords, logging out of shared devices and
            ...
            <Text mb="lg">
              We retain your data for as long as your account is active and as needed to provide you
              with our Services.
            </Text>
            ...
            <List mb="lg" withPadding listStyleType="disc">
              <List.Item>
                <strong>Your data</strong> – All your personal data, contacts, activities, and
              ...
              <List.Item>
                <strong>Logs</strong> – Server logs containing your IP address are retained for up
                to 90 days for security purposes, then deleted or anonymized
              </List.Item>
            </List>
            ...
            <Text mb="lg">
              ...
              Services (see Section 15 for the complete list). These providers are contractually
            ...
            <Text mb="md">
              PixelDev is based in the Czech Republic (EU). Your data may be processed in the
              European Union and potentially in other countries where our service providers operate.
            </Text>
            <Text mb="md">
            ...
            <Text mb="lg">
              We may need to verify your identity before processing your request. In some cases, we
              may not be able to fully comply with your request (for example, if it would affect the
              rights of others or if we have a legal obligation to retain certain data).
            </Text>
            ...
            <Title
              order={2}
              mb="md"
              id="contact-data-responsibilities"
              style={{ scrollMarginTop: 120 }}
            >
              13. Your Responsibilities for Contact Data
            </Title>
            <Text mb="md">
              Bondery allows you to store information about other people (your contacts). When you
              add contact information to Bondery, you are the data controller for that information,
              and we act as a data processor on your behalf.
            </Text>
            <Text mb="md">
            ...
            <List mb="lg" withPadding listStyleType="disc">
              <List.Item>
                Ensuring you have a lawful basis to store and process information about your
                contacts
              </List.Item>
            ...
            <Text mb="lg">
              We may include links to third-party websites or services in our Services. We have no
              control over the content, privacy policies, or practices of any third-party websites
              or services.
            </Text>
            <Text mb="lg">
              We recommend that you review the privacy policies of any third-party websites or
              services you visit through our links. We are not responsible or liable for the
              collection, use, or disclosure of your information by these third parties.
            </Text>
            ...
            <Text mb="lg">
              Bondery uses the following third-party service providers for the provision of services
              as detailed under the Terms. Each provider is contractually obligated to protect your
            ...
            <Text mb="md">
              If you have any questions about this Privacy Policy or how we process your information
              and data, please email us at{" "}
