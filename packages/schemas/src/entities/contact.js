...
import { createdAtSchema, entityAuditSchema, entityIdentitySchema, idsRequestSchema, makeCollectionResponseSchema, makeListResponseSchema, updatedAtSchema, } from "./_shared.js";
const trimmedNameField = (max, label) => z
    .string()
    .trim()
...
export const contactRelationshipsResponseSchema = makeCollectionResponseSchema("relationships", contactRelationshipWithPeopleSchema);
